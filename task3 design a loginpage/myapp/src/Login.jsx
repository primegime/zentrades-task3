...
export default function Login() {
  ...
  const validateForm = () => {
    ...
    if (userP == 1 && specC == 1 && numP == 1 && userN==1 && passS==1 && userV==1){
      return true;
    }else{
      if(userN==0){
      ...
      toast.error("The password field should cannot contain any special character other than @ and must contain an userPpercase letter and a number", toastOptions);
      return false;
    }
  };
